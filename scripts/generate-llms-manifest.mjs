...
const PRIORITY_OVERRIDES = {
  ...
  '/services/crm-and-revenue-operations': { priority: 0.9, changeFrequency: 'monthly' },
  '/services/crm-and-revenue-operations/crm-architecture-governance': { priority: 0.85, changeFrequency: 'monthly' },
  '/services/crm-and-revenue-operations/lifecycle-lead-management': { priority: 0.85, changeFrequency: 'monthly' },
  '/services/crm-and-revenue-operations/revenue-analytics': { priority: 0.85, changeFrequency: 'monthly' },
